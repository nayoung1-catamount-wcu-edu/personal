...
button_frame = LabelFrame(
    root, text="Control Buttons", bg="Turquoise", width=400, height=120
)
...
song_lbl = Label(
    song_frame, textvariable=current_song, bg="Goldenrod", font=("Times", 12), width=25
)
...
Label(
    root, textvariable=song_status, bg="SteelBlue", font=("Times", 9), justify=LEFT
