...
```{r}
df <- read.csv('http://files.zillowstatic.com/research/public/County/County_Zhvi_AllHomes.csv')
head(df)
```
...
```{r}
write.table(df_nc, file="STG_ZLLW_County_Zhvi_All_Homes.txt", sep='\t')
```

```{r}
file.move("STG_ZLLW_County_Zhvi_All_Homes.txt", "../Updates/", overwrite=TRUE)
```